...
class CustomImageExplanation(object):
    ...
    def custom_get_image_and_mask(self, label, positive_only=True, negative_only=False, hide_rest=False,
        ...
        Returns:
            (image, mask, ranked_mask), where image is a 3d numpy array and mask is a 2d
            numpy array that can be used with
            skimage.segmentation.mark_boundaries.
            ranked_mask is a 2d numpy array ranking the super pixels
        """
...
class CustomLimeImageExplainer(object):
    ...
    def custom_explain_instance(self, image, classifier_fn, labels=(1,),
                         hide_color=None,
        ...
        ret_exp = CustomImageExplanation(image, segments)
        if top_labels:
