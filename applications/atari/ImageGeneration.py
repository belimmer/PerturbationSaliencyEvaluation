...
if __name__ == '__main__':
    ...
    if approach == "lime":
        ...
        if segmentation == "slic":
            ...
            kwargs["segmentation_fn"] = segmentation_fn
            kwargs["num_samples"] = 3000
        elif segmentation == "felzenswalb":
            segmentation_fn = ( lambda x: seg.felzenszwalb(x, scale=1, sigma=0.25, min_size=2))
            kwargs["segmentation_fn"] = segmentation_fn
            kwargs["num_samples"] = 2500
    ...
    if approach == "lime":
        og_saliency_fn = (
            lambda kwargs: original_analyzer.generate_lime_explanation(**kwargs)[1])
        saliency_fn_1 = (
            lambda kwargs: analyzer1.generate_lime_explanation(**kwargs)[1])
        saliency_fn_2 = (
            lambda kwargs: analyzer2.generate_lime_explanation(**kwargs)[1])
        saliency_fn_3 = (
            lambda kwargs: analyzer3.generate_lime_explanation(**kwargs)[1])
        saliency_fn_4 = (
